...
<head>
    ...
    <title>OnlineJersey | Ecommerce Website Design</title>
        ...
        <h2 class="title">Featured Products</h2>
           <div class="row">
               <div class="col-4">
                   ...
                   <h4><a href="product-details.php">Liverpool Training Kit</a></h4>
                   <div class="rating">
...
<!----------offer--------------->
   ...
   <div class="offer">
       <div class="small-container">
           ...
           <div class="col-2">
               <p>Exclusively Available on Online Jersey Store</p>
               <h1>Smart Band 4</h1>
       ...
       <div class="row">
           <div class="col-3">
                    <i class="fa fa-quote-left"></i>
                      <p>I have buy 5 jersey from this store and the quality of the product was very amusing</p>
                      <div class="rating">
                           <i class="fa fa-star"></i>
                           <i class="fa fa-star"></i>
                           <i class="fa fa-star"></i>
            ...
            <div class="col-3">
                    <i class="fa fa-quote-left"></i>
                      <p>Come and grab your favorite team jersey.</p>
                      <div class="rating">
                           <i class="fa fa-star"></i>
                           <i class="fa fa-star"></i>
                           <i class="fa fa-star"></i>
            ...
            <div class="col-3">
                    <i class="fa fa-quote-left"></i>
                      <p>Quality of jersey is really great.</p>
                      <div class="rating">
                           <i class="fa fa-star"></i>
                           <i class="fa fa-star"></i>
                           <i class="fa fa-star"></i>
